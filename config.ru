...
<section class='container'>
          <hgroup>
            <h1>Wilkommen to your Ruby application on OpenShift</h1>
          </hgroup>
          ...
          <section class='col-xs-12 col-sm-6 col-md-6'>
            <section>
              <h2>Deploying code changes</h2>
                <p>
                  xxxxxxxxxxxxxThe source code for this application is available to be forked from the <a href="https://www.github.com/openshift/ruby-ex">OpenShift GitHub repository</a>.
